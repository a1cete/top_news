...
// 修改头条回显的接口
export const getFindHeadlineByHid = (info) => {
    return request.post("user/checkPassword",info);
};

//重置密码接口
export const restPassword = (info) => {
  return request.post("user/restPassword",info)
}
...
//注销账号的接口
export const logOutAccount = (uid) => {
  return request.post("user/logOutAccount",uid)
}
